...
export default function DefaultButton({
  ...
  return (
    <button
      ...
      } focus-visible:ring-2 focus-visible:ring-primary-green focus-visible:ring-offset-2 focus-visible:outline-none hover:enabled:scale-105 active:enabled:scale-95 disabled:cursor-not-allowed disabled:opacity-50`}
    >
      {children}
    </button>
  )
