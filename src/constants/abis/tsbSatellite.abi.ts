export const tsbSatelliteABI = [
  {
    inputs: [
      ...
      { internalType: 'uint32', name: '_gmcEid', type: 'uint32' },
    ],
  ...
  { inputs: [], name: 'GMCEidNotSet', type: 'error' },
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: 'uint32', name: 'receivedEid', type: 'uint32' }],
    name: 'InvalidGMCEid',
    type: 'error',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'enum MintStatus', name: 'status', type: 'uint8' },
